...
"""helper methods for sphinx documentation"""
...
def process_param(line):
    ...
    try:
        ...
        print "sphinx extension: Not able to process param: '%s'" % line
        print "      Reason:", str(e)
...
def process_return(line):
    ...
    try:
        ...
        print "sphinx extension: Not able to process 'return': '%s'" % line
        print "      Reason:", str(e)
        new_lines.append(line)
    return new_lines
...
def process_raise(line):
    ...
    try:
        ...
        print "sphinx extension: Not able to process 'raise': '%s'" % line
        print "      Reason:", str(e)
        new_lines.append(line)
    return new_lines
