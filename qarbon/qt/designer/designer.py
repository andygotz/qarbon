...
import qarbon
from qarbon.external.qt import Backend, QtCore
...
def get_qtdesigner_bin():
    ...
    if plat == "darwin":
        ...
        designer_bin = os.path.abspath(os.path.dirname(Backend.__file__))
...
def qtdesigner_prepare_taurus(env=None, extra_path=None):
    ...
    if extra_path is not None:
        append_or_create_env(env, "QARBONQTDESIGNERPATH", extra_path)
...
def main(env=None):
    ...
    env = qtdesigner_prepare_taurus(env=env, extra_path=extra_path)
